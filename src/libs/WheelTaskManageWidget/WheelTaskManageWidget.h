#ifndef WHEEL_TASK_MANAGE_WIDGET_H_
#define WHEEL_TASK_MANAGE_WIDGET_H_
...
private slots:
	...
	void onUpdateDeleteResult(int strUuid, bool isSuccess, QString strMsg);

	void onUpdateSaveTaskResult(int strUuid, bool isSuccess, QString strMsg);
...
#endif // !WHEEL_TASK_MANAGE_WIDGET_H_
