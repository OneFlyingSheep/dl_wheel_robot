#ifndef CUSTOM_CALENDAR_INFO_H
#define CUSTOM_CALENDAR_INFO_H
...
class CustomCalendarInfo : public QObject
{
    Q_OBJECT
public:
    static CustomCalendarInfo *Instance();
    explicit CustomCalendarInfo(QObject *parent = 0);
    ...
    void getCustomCalendarInfo(int year, int month, int day,
                              QString &strHoliday,
...
private:
    static CustomCalendarInfo *self;
