...
public:
	...
	void insertData(WheelStandardPatrolVindicateStruct data)
	{
		initData();

		m_deviceTypeWidget->setComboBoxCurrentContent(data.m_device_type_name);
		m_subDeviceTypeWidget->setComboBoxCurrentContent(data.m_sub_device_name);
		m_devicePointNameWidget->setComboBoxCurrentContent(data.m_device_point_name);
		m_recognitionTypeWidget->setComboBoxCurrentContent(data.m_recognition_type_name);
		m_meterTypeWidget->setComboBoxCurrentContent(data.m_meter_type_name);
		m_feverTypeWidget->setComboBoxCurrentContent(data.m_fever_type_name);
		m_saveTypeWidget->setComboBoxCurrentContent(data.m_save_type_name);
...
private:
    ...
    void initWidget()
    {
        ...
        m_feverTypeWidget->setTipText("设备序列号");
